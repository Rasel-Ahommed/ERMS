                    ...
                    <div class="col-sm-6">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">My Monthly Reports</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body" style="overflow: auto;">
                                ...
                                <h4 class="card-title text-center fs-3">My Monthly Reports</h4>
                                <form action="{{ route('get-my-monthly-report') }}" method="post">
                                    @csrf
                                ...
                                <div style="overflow: auto;">
                                    ...
                                    <table id="datatable-buttons" style="overflow: auto;"
                                        ...
                                        <tbody>
                                            @php
                                                $totalMinutes = 0;
                                                $my_monthly_reports = session()->get('my_monthly_reports');
                                            @endphp



                                            @if (isset($my_monthly_reports))

                                                @foreach ($my_monthly_reports as $report)
                                                    @php
